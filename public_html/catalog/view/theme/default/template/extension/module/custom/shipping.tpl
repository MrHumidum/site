          ...
          <?php foreach ($shipping_method['quote'] as $quote) { ?>
            <div class="radio">
              <label>
                ...
                <?php } ?>
                <?php echo $quote['title']; ?> - <?php if ($quote["cost"] > 0) { echo $quote["text"]; } else { echo $text_free; } ?>
        ...
        <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
          ...
          <?php foreach ($setting['fields'] as $field) { ?>
            ...
            <?php if ($field['name'] === 'city') { ?>
              <div class="form-group required" id="shipping-field-city">
                <label class="control-label" for="input-shipping-city"><?php echo $entry_city; ?></label>
                <select name="city" id="input-shipping-city" class="form-control" required="required">
                  <option value=""><?php echo $text_city_select; ?></option>
                  <?php foreach ($cities as $city_code => $city_name) { ?>
                  <option value="<?php echo $city_name; ?>"<?php echo ($city_name == $city ? ' selected="selected"' : ''); ?>><?php echo $city_name; ?></option>
                  <?php } ?>
                </select>
              </div>
            <?php } ?>
