      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-article" class="form-horizontal">
          ...
          <div class="tab-content">
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="input-date-added">Дата добавления</label>
                <div class="col-sm-3 input-group date">
                  <input type="text" name="filter_date_added" value="<? echo $date_added; ?>" placeholder="Дата добавления" data-date-format="YYYY-MM-DD" id="input-date-added" class="form-control">
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="input-manufacturer"><span data-toggle="tooltip" title="<?php echo $help_manufacturer; ?>">Автор</span></label>
                <div class="col-sm-10">
