<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="bt_hint" id="bt-payment-hint" style="display:none;"><?php echo $text_bank_transfer_hint; ?></div>

    <script>
    $(function(){
        var toggleBankHint = function() {
            var selected = $('#custom-payment input[name=\'payment_method\']:checked').val();
            $('#bt-payment-hint').toggle(selected === 'bank_transfer');
        };
        $(document).on('change', '#custom-payment input[name=\'payment_method\']', toggleBankHint);
        toggleBankHint();
    });
    </script>
