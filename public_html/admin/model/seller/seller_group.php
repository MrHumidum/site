...
class ModelsellersellerGroup extends Model {
	public function addsellerGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "seller_group SET approval = '" . (int)$data['approval'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editsellerGroup($seller_group_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "seller_group SET approval = '" . (int)$data['approval'] . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE seller_group_id = '" . (int)$seller_group_id . "'");
