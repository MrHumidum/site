  ...
  <div class="container">
    <div class="category_wrap">
      <div class="c_c_head mob">
        ...
        <p>Игр в категории: <span><span class="totalcountmob"><? echo $totalcount;?></span> шт.</span></p>
      </div>
...
<div class="category_card_box">
        <div class="c_c_head desk">
          <h2 class="title c_c_title"><?php echo $heading_title; ?></h2>
          <p>Игр в категории: <span ><span class="totalcount"><? echo $totalcount;?></span> шт.</span></p>
        </div>
  <?php if ($products) { ?>
