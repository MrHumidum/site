...
$_['heading_title'] = 'ЮKassa (банковские карты, ЮMoney, интернет-банки, наличные, счет мобильного и другие)';

$_['heading_payment'] = $_['heading_title'];
$_['text_continue'] = 'Перейти к оплате';
$_['kassa_title'] = $_['heading_title'];

$_['text_method_yoo_money'] = 'ЮMoney';
...
$_['text_method_widget'] = 'Банковские карты, Apple Pay, Google Pay';
$_['text_method_sber_loan'] = '«Покупки в кредит» от СберБанка';
...
$_['yoomoney_b2b_sberbank'] = 'Сбербанк Бизнес Онлайн';
...
$_['error_minimum'] = 'Заказ меньше минимальной суммы';

$_['second_receipt_history'] = 'Отправлен второй чек. Сумма %s рублей.';

$_['text_payment_on_hold'] = 'Платеж на удержании';

$_['text_sber_loan_name_discount'] = 'Рассрочка от СберБанка';
$_['text_history_sber_loan_discount'] = '«Покупки в кредит» от СберБанка. Скидка при оплате в рассрочку: ';
