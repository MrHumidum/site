...
<section id="office">
  <div class="container">
    ...
    <div class="panel panel-default">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-discount">Размер скидки</label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-uses-total"><span data-toggle="tooltip" title="<?php echo $help_uses_total; ?>">Количество применений</span></label>
                <div class="col-sm-10">
                  <input type="text" name="uses_total" value="" placeholder="<?php echo $entry_uses_total; ?>" id="input-uses-total" class="form-control" />
                </div>
              </div>
              <div class="form-group hidden">
                ...
                <div class="col-sm-10">
                  <input type="text" name="uses_customer" value="" placeholder="<?php echo $entry_uses_customer; ?>" id="input-uses-customer" class="form-control" />
                </div>
              </div>
              <div class="form-group">
      ...
      <br><br>
            <div  id="tab-history">
			<h3>История использования</h3>
              <div id="history"></div>
            </div>
	
           <br><br>
          </div>
          <button class="btn-default">Сохранить</button>
        </form>
      </div>
    </div>
  </div>
...
$('input[name=\'product\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=add/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
...
$('#history').load('index.php?route=account/coupon/history&token=<?php echo $token; ?>&coupon_id=<?php echo $coupon_id; ?>');
//--></script>
  <?php } ?>
  <script type="text/javascript"><!--
$('.date').datetimepicker({
