...
<li><a href="#tab-easyphoto" data-toggle="tab">Easyphoto</a></li>
...
<div class="form-group">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-order">Приоритет</label>
                <div class="col-sm-10">
                  <input type="text" name="sort_order" value="<?php echo $sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
                </div>
              </div>
			   <div class="form-group">
                <label class="col-sm-2 control-label">Выводить на главной</label>
                                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($jan) { ?>
                    <input type="radio" name="jan" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="jan" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$jan) { ?>
                    <input type="radio" name="jan" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="jan" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
...
<div class="form-group">
                <label class="col-sm-2 control-label" for="input-manufacturer"><span data-toggle="tooltip" title="<?php echo $help_manufacturer; ?>">Продавец</span>
				<?php if ($error_manufacturer_id) { ?>
                  <div class="text-danger"><?php echo $error_manufacturer_id; ?></div>
                  <?php } ?>
				</label>
                <div class="col-sm-10">
