...
class ControllerAddRecurring extends Controller {
	private $error = array();
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_add_recurring->addRecurring($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_add_recurring->editRecurring($this->request->get['recurring_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $recurring_id) {
				$this->model_add_recurring->deleteRecurring($recurring_id);
			}
	...
	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy()) {
			foreach ($this->request->post['selected'] as $recurring_id) {
				$this->model_add_recurring->copyRecurring($recurring_id);
			}
	...
	protected function getList() {
		...
		$recurring_total = $this->model_add_recurring->getTotalRecurrings();

		$results = $this->model_add_recurring->getRecurrings($filter_data);
	...
	protected function getForm() {
		...
		if (isset($this->request->get['recurring_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$recurring_info = $this->model_add_recurring->getRecurring($this->request->get['recurring_id']);
		}
		...
		if (isset($this->request->post['recurring_description'])) {
			...
			$data['recurring_description'] = $this->model_add_recurring->getRecurringDescription($recurring_info['recurring_id']);
		} else {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $recurring_id) {
			$product_total = $this->model_add_product->getTotalProductsByProfileId($recurring_id);
