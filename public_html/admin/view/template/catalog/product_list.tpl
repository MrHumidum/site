          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-name">Название Игры</label>
           ...
           <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-manufacturer-name">Продавец</label>
                <div class="input-group">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Название Игры</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>">Название Игры</a>
                    <?php } ?></td>
