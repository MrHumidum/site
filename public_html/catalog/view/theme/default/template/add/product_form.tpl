...
<li><a href="#tab-easyphoto" data-toggle="tab">Изображения</a></li>
          ...
          <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description_mini<?php echo $language['language_id']; ?>">Состав</label>
                    <div class="col-sm-10">
...
<div class="form-group">
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="quantity" value="<?=$quantity?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
                </div>
              </div>
<div class="form-group hidden">
  ...
  $(this).toggleClass('checked');
      ...
      <div class="tab-pane" id="tab-extra">
          <div class="row">
		   ...
		   <div class="pull-left">
        <button type="submit" form="form-product" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="add_product_btn">Сохранить</button>
        </div>
        </form>
      </div>
    </div>
