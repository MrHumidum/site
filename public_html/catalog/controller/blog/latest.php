...
class ControllerBlogLatest extends Controller { 	
	public function index() { 
		...
		$this->document->addStyle('css/blog/style.css');
$this->document->addStyle('media/blog/media.css');
...
if ($result['userimage']) {$userimage = $this->model_tool_image->resize($result['userimage'], 90,90);}
