...
class ModelBlogArticle extends Model { 
	public function addArticle($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "article SET status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "', user_id = '" . (int)$data['manufacturer_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added ='" . $this->db->escape($data['filter_date_added']) . "' ");
	...
	public function editArticle($article_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "article SET status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "', user_id = '" . (int)$data['manufacturer_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added ='" . $this->db->escape($data['filter_date_added']) . "',  date_modified = NOW() WHERE article_id = '" . (int)$article_id . "'");
