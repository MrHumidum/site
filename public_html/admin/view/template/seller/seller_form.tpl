...
<div id="content">
  ...
  <div class="container-fluid">
                ...
                <div class="col-sm-12">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-lastname">текст</label>
                        <div class="col-sm-10">
                          <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="текст автора" id="input-lastname" class="form-control" />
    ...
    <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="<?php echo $help_keyword; ?>">SEO URL</span></label>
                <div class="col-sm-10">
                  <input type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="адрес страницы" id="input-keyword" class="form-control" />
				   <?php if ($keyword_error) { ?>
                          <div class="text-danger">URL уже занят</div>
                          <?php } ?>
                </div>
              </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-fax">% комиссии</label>
                        <div class="col-sm-10">
                          <input type="text" name="fax" value="<?php echo $fax; ?>" placeholder="введите % комиссии" id="input-fax" class="form-control" />
                        </div>
                      </div>
                      ...
                      <?php } ?>
                      <div class="form-group ">
                        <label class="col-sm-2 control-label" for="input-password"><?php echo $entry_password; ?> (Заполнить для смены пароля)</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group ">
                        <label class="col-sm-2 control-label" for="input-confirm"><?php echo $entry_confirm; ?> (Заполнить для смены пароля)</label>
                        <div class="col-sm-10">
