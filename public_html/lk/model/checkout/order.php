...
$bonus = ($product['price']-$discount)*((100-$product['komis'])/100);
...
$this->db->query("INSERT INTO " . DB_PREFIX . "bonus SET order_id = '" . (int)$order_id . "', summ = '" . (float)$bonus . "', user_id = '" . (int)$product['manufacturer_id'] . "', prname = '" . $product['name'] . "', product_id = '" . (int)$product['product_id'] . "' , cost='".$product['price']."', costtotal='".$costtotal."', status=0 , date = NOW()");
