...
$_['module_title']             = 'ЮKassa';
$_['heading_title']            = $_['module_title'];
$_['text_yoomoney']            = '<a target="_blank" href="https://yookassa.ru"><img src="../image/payment/yoomoney/yookassa_logo.png" alt="ЮMoney от ЮKassa" /></a>';
...
$_['kassa_page_title']                = 'Настройки модуля ЮKassa';
...
$_['kassa_payment_process']             = '<strong>Как будет проходить оплата:</strong> покупатель из вашего магазина перейдёт на страницу ЮKassa и заплатит любым из способов, которые вы подключили.<br><a href="https://yookassa.ru/developers/payment-acceptance/integration-scenarios/smart-payment">Подробнее про сценарий оплаты</a>';
...
$_['kassa_payment_method_mobile_balance'] = 'Баланс мобильного';
...
$_['kassa_payment_method_sber_loan']    = '«Покупки в кредит» от СберБанка';
...
$_['kassa_tax_rate_9_label']             = 'Расчетная ставка 5/105';
$_['kassa_tax_rate_10_label']            = 'Расчетная ставка 7/107';
...
$_['kassa_tab_header']   = 'Настройки модуля';
...
//Updater
$_['update_tab_header']                  = 'Обновления';
...
$_['kassa_hold_setting_description']   = 'Если включить, платежи будут проходить в два этапа: сначала деньги заблокируются на счёте покупателя, а уже после вашего подтверждения — спишутся.<br>Подтвердить или отменить платёж нужно за определённое время, которое <a href="https://yookassa.ru/developers/payment-acceptance/getting-started/payment-methods#all" target="_blank">зависит от способа оплаты</a> — если ничего не сделать, деньги разблокируются и вернутся на счёт покупателя.';
...
$_['sber_loan_warning_title'] = 'У вас подключен способ оплаты «Покупки в кредит» от СберБанка';
$_['sber_loan_warning_text']  = 'В него входит обычный кредит и <a href="https://yookassa.ru/developers/payment-acceptance/integration-scenarios/manual-integration/other/sber-loan#payment-method-overview-loan-options" target="_blank">рассрочка без переплаты</a>. У рассрочки есть особенности:
 <br>&mdash;&nbsp;К&nbsp;заказу автоматически применяется небольшая скидка. Она компенсирует проценты, которые покупатель заплатит банку&nbsp;&mdash; в&nbsp;итоге покупатель не&nbsp;переплачивает.
 <br>&mdash;&nbsp;В&nbsp;истории заказов в&nbsp;CMS может отображаться неверная сумма заказа. На&nbsp;сам платёж это не&nbsp;влияет: покупатель заплатит правильную сумму, а&nbsp;магазин получит сумму платежа за&nbsp;вычетом скидки и&nbsp;комиссии ЮKassa.
 Проверяйте сумму <a href="https://yookassa.ru/my/payments" target="_blank">в&nbsp;личном&nbsp;кабинете&nbsp;ЮKassa</a>&nbsp;&mdash; там она всегда правильная.';
$_['sber_loan_warning_text_more']  = 'Подробнее — <a href="https://yookassa.ru/docs/support/payments/onboarding/integration/cms-module/opencart2#sber" target="_blank">в документации ЮKassa</a>';
