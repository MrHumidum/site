...
$this->document->addStyle('css/page/style.css');
$this->document->addStyle('media/page/media.css');		
...
if ($article_info['userimage']) {

$data['viewed'] = 	$article_info['viewed'];
$data['userimage'] = $this->model_tool_image->resize($article_info['userimage'], 90,90);}
	else {$data['userimage'] = false; }	
 
$data['user'] = $article_info['user'];
			$url = '';
