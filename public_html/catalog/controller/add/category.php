...
class ControllerAddCategory extends Controller {
	private $error = array();
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_add_category->addCategory($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_add_category->editCategory($this->request->get['category_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
				$this->model_add_category->deleteCategory($category_id);
			}
	...
	public function repair() {
		...
		if ($this->validateRepair()) {
			$this->model_add_category->repairCategories();
	...
	protected function getList() {
		...
		$url = '';
		$category_total = $this->model_add_category->getTotalCategories();
	...
	protected function getForm() {
		...
		if (isset($this->request->get['category_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$category_info = $this->model_add_category->getCategory($this->request->get['category_id']);
		}
		...
		if (isset($this->request->post['category_description'])) {
			...
			$data['category_description'] = $this->model_add_category->getCategoryDescriptions($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_filter'])) {
			...
			$filters = $this->model_add_category->getCategoryFilters($this->request->get['category_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['category_store'])) {
			...
			$data['category_store'] = $this->model_add_category->getCategoryStores($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_add_category->getProductRelated($this->request->get['category_id']);
		} else {
			$products = array();
		}	
		...
		if (isset($this->request->post['article_related'])) {
			...
			$articles = $this->model_add_category->getArticleRelated($this->request->get['category_id']);
		} else {
			$articles = array();
		}			
		...
		if (isset($this->request->post['category_layout'])) {
			...
			$data['category_layout'] = $this->model_add_category->getCategoryLayouts($this->request->get['category_id']);
		} else {
	...
	protected function validateForm() {
		...
		if (isset($this->request->get['category_id']) && $this->request->post['parent_id']) {
			$results = $this->model_add_category->getCategoryPath($this->request->post['parent_id']);
	...
	public function enable() {
        ...
        if (isset($this->request->post['selected'])) {
            foreach ($this->request->post['selected'] as $category_id) {
                $this->model_add_category->editCategoryStatus($category_id, 1);
            }
            $this->session->data['success'] = $this->language->get('text_success');
            $url = '';
            if (isset($this->request->get['page'])) {
    ...
    public function disable() {
        ...
        if (isset($this->request->post['selected'])) {
            foreach ($this->request->post['selected'] as $category_id) {
                $this->model_add_category->editCategoryStatus($category_id, 0);
            }
            $this->session->data['success'] = $this->language->get('text_success');
            $url = '';
            if (isset($this->request->get['page'])) {
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$results = $this->model_add_category->getCategories($filter_data);
	...
	private function getCategories($parent_id, $parent_path = '', $indent = '') {
		...
		$results = $this->model_add_category->getCategoriesByParentId($parent_id);
		foreach ($results as $result) {
