...
<?php } ?>
<script src="catalog/view/javascript/common.js?v<? echo time();?>" type="text/javascript"></script>
...
<link rel="stylesheet" href="css/style.css?v=11">
  <link rel="stylesheet" href="media/media.css?v1">

<link rel="stylesheet" href="css/card/style.css">
  <link rel="stylesheet" href="media/card/media.css">
