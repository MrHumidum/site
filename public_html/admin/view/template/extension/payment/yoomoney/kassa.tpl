...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title qa-title"><i class="fa fa-pencil"></i> <?php echo $language->get('kassa_page_title'); ?></h3>
    </div>
    <div class="panel-body">
        <div>
            <p><?php echo $language->get('kassa_header_description'); ?></p>
            <p class="qa-module-version"><?php echo $language->get('kassa_version_string'); ?> <?php echo $module_version; ?></p>
        </div>

        <?php if ($kassa->isSberLoanAvailable()) : ?>
        <div class="col-12">
            <div class="alert alert-warning offset-top-10" role="alert">
                <p><strong><?php echo $language->get('sber_loan_warning_title'); ?></strong></p>
                <p><?php echo $language->get('sber_loan_warning_text'); ?></p>
                <p><?php echo $language->get('sber_loan_warning_text_more'); ?></p>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
                <label>
                    <input type="checkbox" class="enable-button qa-enable-yookassa-checkbox" id="kassa-enabled" name="yoomoney_kassa_enabled" value="on"<?php echo $kassa->isEnabled() ? ' checked' : ''; ?> />
                    <?php echo $language->get('kassa_enable_label'); ?>
                </label>
                <?php if (!empty($error_kassa_enabled)) : ?>
                <div class="text-danger"><?php echo $error_kassa_enabled; ?></div>
                <?php endif; ?>
            </div>
        </div>

        <?php include_once $module->incl('parts/auth.tpl'); ?>

        <!-- Payment method start -->
        <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
                <p><?php echo $language->get('kassa_payment_process'); ?></p>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="kassa-b2b-sberbank-on"><?php echo $language->get('b2b_sberbank_label'); ?></label>
            <div class="col-sm-10">
                <label>
        ...
        <!-- Hold mode start -->
        <div class="form-group">
            <label class="col-sm-2 text-right" for="kassa-enable-hold-mode">
                <?php echo $language->get('kassa_hold_setting_label'); ?>
            </label>
            <div class="col-sm-10">
                <input type="checkbox" class="qa-enable-hold-control" id="kassa-enable-hold-mode" name="yoomoney_kassa_enable_hold_mode" value="on"<?php echo $kassa->getEnableHoldMode() ? ' checked' : ''; ?> />
        ...
        <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
                <?php if(!$kassa->isSendReceipt()): ?>
                    <h4><?= $language->get('kassa_auth_enable_54fz_title') ?></h4>
                    <p><?= $language->get('kassa_auth_enable_54fz') ?></p>
                <?php endif; ?>
            </div>
            <label class="col-sm-2 text-right" for="kassa-send-receipt">
                <?php echo $language->get('kassa_send_receipt_label'); ?>
            </label>
            <div class="col-sm-10">
                <input type="checkbox" class="qa-enable-receipt-control" id="kassa-send-receipt" name="yoomoney_kassa_send_receipt" value="on"<?php echo $kassa->isSendReceipt() ? ' checked' : ''; ?> />
            </div>
        </div>
        <div class="col-sm-10 col-sm-offset-2">
            ...
            <div class="form-group receipt-only">
                ...
                <div class="col-sm-10">
                    <label style="font-weight: 600; padding-top: 9px; cursor: pointer" class="form-check-label">
                        <input style="vertical-align:middle;margin:-2px 3px 0 0;cursor: pointer" type="radio" id="kassa-second-receipt-enable-on" name="yoomoney_kassa_second_receipt_enable" value="1" class="form-check-input qa-second-receipt-enable" <?= $kassa->isSecondReceipt() ? "checked" : '' ?>/>
                    ...
                    <label style="font-weight: 600; margin-left: 10px; cursor: pointer" class="form-check-label">
                        <input style="vertical-align:middle;margin:-2px 3px 0 0;cursor: pointer" type="radio" id="kassa-second-receipt-enable-off" name="yoomoney_kassa_second_receipt_enable" value="0" class="form-check-input qa-second-receipt-disable" <?= $kassa->isSecondReceipt() ? '' : "checked" ?>/>
                ...
                <div class="col-sm-10 col-sm-offset-2 second-receipt-wrapper">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td style="border: none">
                                <select id="kassa-second-receipt-status" name="yoomoney_kassa_second_receipt_status"
