            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <input type="text" name="filter_email" value="<? echo $filter_email;?>" placeholder="email покупателя" id="input-email" class="form-control" />
              </div>
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <input type="text" name="filter_phone" value="<? echo  $filter_phone;?>" placeholder="телефон покупателя" id="input-phone" class="form-control" />
              </div>
