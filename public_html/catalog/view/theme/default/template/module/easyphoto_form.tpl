  ...
  <div class="easyphoto_container">
    <div class="easyphoto_top row">
      ...
      <div class="col-sm-8">
        <?php if($easyphoto_for){ ?>
          <h3 class="text_ellipsis">Выберете изображения</h3>
        <?php }else{ ?>
          ...
          <script>
            $(document).on('click', 'a[href="#tab-easyphoto"]', function(){
              ...
              $('#photo_for').text("Выберете изображения " + name);
            });
          </script>
        <?php } ?>
    ...
    <div class="row">
      ...
      <div class="col-sm-8 paddingr0">
        <h3>Изображения (<span id="photos_count"><?php echo count($product_images); ?></span>)</h3>
      ...
      <div class="col-sm-4 text-center position_relative">
        <h3>Удалить (<span id="trash_count"><?php echo count($trash_photos); ?></span>)</h3>
