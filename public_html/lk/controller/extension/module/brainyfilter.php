...
class ControllerExtensionModuleBrainyFilter extends Controller {
  ...
  $manufacturer_id = isset($this->request->get['autor_id']) ? $this->request->get['autor_id'] : '';
	   
$this->load->model('catalog/category');
$this->_data['categoriesar'] = array();
        ...
        if ($isMijoShop) {
            MijoShop::get('base')->addHeader(JPATH_MIJOSHOP_OC . '/catalog/view/javascript/brainyfilter.js?v='.time(), false);
        } else {
            $this->document->addScript('catalog/view/javascript/brainyfilter.js?v='.time());
        }
...
//            }
	...
	private function _prepareFilterInitialData()
	{
		...
		$data = array(
            ...
            'filter_manufacturer_id' => $this->_getRequestParam('auto_id', 0),
