...
public function getBonusAll($userid) {
		$query = $this->db->query("SELECT SUM(summ) AS total  FROM `" . DB_PREFIX . "bonus` b LEFT JOIN `" . DB_PREFIX . "order` o ON (o.order_id=b.order_id) where o.order_status_id > '1' AND user_id = '" . $userid . "'");
