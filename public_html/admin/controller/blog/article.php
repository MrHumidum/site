...
$this->load->model('customer/customer');
		if (isset($this->request->post['manufacturer_id'])) {
			...
			$data['manufacturer_id'] = $article_info['user_id'];
		} else {
...
if (isset($this->request->post['manufacturer'])) {
			...
			$manufacturer_info = $this->model_customer_customer->getCustomer($article_info['user_id']);
...
if (isset($this->request->post['filter_date_added'])) {
			$data['date_added'] = $this->request->post['filter_date_added'];
		} elseif (!empty($article_info)) {
