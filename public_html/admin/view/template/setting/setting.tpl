        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-geocode"><span   >youtube</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_geocode" value="<?php echo $config_geocode; ?>" placeholder="ссылка youtube" id="input-geocode" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
			   ...
			   <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-invoice-prefix"><span data-toggle="tooltip" title="отображается в подвале сайта">Email на сайте</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_invoice_prefix" value="<?php echo $config_invoice_prefix; ?>" placeholder=" " id="input-invoice-prefix" class="form-control" />
                  </div>
                </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax">Ютуб</label>
                <div class="col-sm-10">
                  <input type="text" name="config_fax" value="<?php echo $config_fax; ?>" placeholder="ссылка instagram" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
