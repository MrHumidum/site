...
$filter_data = array(
			...
			'filter_date_1'    => $filter_date_added,
			'filter_date_2' => $filter_date_modified,
...
$data['summa'] = $this->model_sale_order->getTotalOrdersSumm($filter_data);
$data['bonus'] = $this->model_sale_order->getTotalBonusSumm($filter_data);
...
$custtotal = $this->model_sale_order->getTotaltotalsCust($filter_data2);
 $vyvod = $this->model_sale_order->getTotalVyvodCust($filter_data2);
 $ostatok = $custtotal['summ'] -  $vyvod;
$komis = $custtotal['costtotal'] - $custtotal['summ'];
if (isset($this->request->get['filter_date_modified'])) {
$vyvod = '-';
$ostatok = '-';
}
