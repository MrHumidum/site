...
class KassaModel extends AbstractPaymentModel
{
    ...
    public function getPaymentSubjectEnum()
    {
        return array(
            ...
            PaymentSubject::GAMBLING_PRIZE        => 'Вытоварыш в азартной игре ('.PaymentSubject::GAMBLING_PRIZE.')',
            PaymentSubject::LOTTERY               => 'Лотерейный билет ('.PaymentSubject::LOTTERY.')',
            PaymentSubject::LOTTERY_PRIZE         => 'Вытоварыш в лотерею ('.PaymentSubject::LOTTERY_PRIZE.')',
